...
function makeMessage(event: OrderEmailEvent, order: OrderEmailData) {
  ...
  const text = [copy.title, copy.intro, "", ...detailLines, "", "用户中心：https://reiishop.cn/account"].join("\n");
